<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla_Video.Master" AutoEventWireup="true" CodeBehind="Alquilar.aspx.cs" Inherits="P_Taller3.Alquilar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        <span style="font-family: 'Agency FB'; font-weight: bold; font-size: xx-large; color: #CC0000">Alquiler Video</span><table style="width:100%;">
            ...
            <tr>
                <td colspan="3">
                    <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Codigo_Video" DataSourceID="ObjectDataSource2" Font-Bold="True" Font-Names="Agency FB" Font-Size="Large" Height="50px" Width="309px">
                        <Fields>
                        ...
                        <FooterStyle BorderColor="#CC0000" />
                    </asp:DetailsView>
                    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByXCod" TypeName="P_Taller3.dsVideoTableAdapters.tVideo1TableAdapter" UpdateMethod="Update">
                        <DeleteParameters>
                        ...
                        <SelectParameters>
                            <asp:QueryStringParameter DefaultValue="V0000" Name="Codigo_Video" QueryStringField="Codigo_Video" Type="String" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="Titulo_Video" Type="String" />
                            <asp:Parameter Name="Sinopsis_Video" Type="String" />
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete" InsertMethod="Insert" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataByXCod" TypeName="P_Taller3.dsVideoTableAdapters.tVideo1TableAdapter" UpdateMethod="Update">
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextBox4" DefaultValue="V0000" Name="Codigo_Video" PropertyName="Text" Type="String" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="Titulo_Video" Type="String" />
                            <asp:Parameter Name="Sinopsis_Video" Type="String" />
